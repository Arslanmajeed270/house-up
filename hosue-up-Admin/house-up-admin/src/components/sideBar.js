        ...
        return (
            ...
            <div id="sidebar" className={ this.props.sideBarState ? "sidebar py-3 shrink show": "sidebar py-3 " }>
                     <ul className="sidebar-menu list-unstyled">
                         ...
                         <li className="sidebar-list-item"><Link to="/posts" className="sidebar-link text-muted"><i className="o-trophy-1 mr-3 text-gray"></i><span>Post</span></Link></li>
                         <li className="sidebar-list-item"><Link to="/stories" className="sidebar-link text-muted"><i className="o-sales-up-1 mr-3 text-gray"></i><span>Post Bost</span></Link></li>
