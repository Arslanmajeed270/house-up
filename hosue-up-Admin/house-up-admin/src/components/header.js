...
class header extends Component {
  ...
  render() {
    const { sideBarHandler, 
      // notificationState, notificationToggle, 
      userShowState, userToggleHandler } = this.props;
    return (
      <React.Fragment>
        <header className="header">
          <nav className="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
            ...
            <i className="fas fa-align-left" onClick={sideBarHandler} /></Link>
  ...
  {/*                     
              <li className= { notificationState ?  "nav-item dropdown mr-3 show" : "nav-item dropdown mr-3"} >
                ...
                >
                  <i className="fa fa-bell" onClick={ notificationToggle } />
                  <span className="notification-icon" />
                  </Link>
                <div aria-labelledby="notifications" className={ notificationState ? "dropdown-menu show" : "dropdown-menu"}><Link to="#" className="dropdown-item">
                ...
                */}
              <li className={ userShowState ? "nav-item dropdown ml-auto show" : "nav-item dropdown ml-auto"}>
                <Link id="userInfo" to="" 
                ...
                className={ userShowState ? "dropdown-menu show" : "dropdown-menu"}>
                  ...
                  <div className="dropdown-divider" /><Link to="/login" onClick={(e) => {
                    e.preventDefault();
                    this.logoutHandler();
