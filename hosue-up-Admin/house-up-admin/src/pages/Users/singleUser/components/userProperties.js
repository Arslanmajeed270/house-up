...
import './style.css';
export default function UserProperties( { userProperties } ) {
    ...
    <Accordion defaultActiveKey="0" style={{marginTop: "30px"}}>
        <Card>
            ...
            <Accordion.Collapse eventKey="0">
                <Card.Body>
                    <Row>
                    { userProperties.length >  0 ? userProperties.map( (data, index) => (
                        ...
                        <Col xs={6} key={index} >
                            <Media>
                                ...
                                <Media.Body style={{paddingTop: "10px"}}>
                                    <h3 className="userPropertiesCardImgHeading" > {data.object && data.object.adTitle && data.object.adTitle} </h3>
                                    <p className="userPropertiesCardImgDescription" > {data.object && data.object.description && data.object.description} </p>
                                    <p className="userPropertiesCardImgDescription" > ${data.object && data.object.price ? data.object.price : 0}
                        ...
                        <Col>
                        <p style={{textAlign: "center"}} >No property found!</p>
                        </Col> 
                         }
                    </Row>
                    {/* <Pagination>
