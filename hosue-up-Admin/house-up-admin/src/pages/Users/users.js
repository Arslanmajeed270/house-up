...
import { getUsersData, updateVendorsState } from '../../store/actions/index';
...
class Vendors extends Component {
  ...
  updateUserState = ( userStatus , userId ) =>
  {
...
const mapDispatchToProps = dispatch => {
  return {
      ...
      onUpdateUserState: (reqPacket)=> dispatch(updateVendorsState(reqPacket))
  }
};
