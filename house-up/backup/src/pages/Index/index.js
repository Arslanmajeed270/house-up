                                      ...
                                      <div className="dashboard-newsfeed-content">
                                        ...
                                        data.category === 'Post' ? (
                                          ...
                                          <>
                                            ...
                                            <div className="row">
                                              ...
                                              <div className="col-md-6 col-sm-6 col-6">
                                                <div
                                                  ...
                                                  style={{ textAlign: 'right',fontSize:'20px', paddingRight:'15px' }}
                                                >
                                                  <span>
                                                    <b>
                                                      {' '}
                                            ...
                                            <div className="dashboard-newsfeed-details" style={{marginBottom:'0px'}}>
                                              {data && data.category === 'Post'
                                                ? data &&
                                                  data.object &&
                                                  this.limitWordHandler(
                                      ...
                                      <div className="vendor-box">
                                        ...
                                        <div className="custom-row-styles" style={{bottom: '0px', padding:'0px'}}>
                                          ...
                                          <div className="navWrap">
                                            ...
                                            data.object.vendorLikes.length >=
                                              1 ? (
                                              <div className="likedByText" style={{paddingBottom:'5px'}}>
                                                {' '}
                                                Liked by{' '}
                                                {data.object.vendorLikes[
                                                  data.object.vendorLikes
