(function($) {
    ...
    if ($('.pxp-props-carousel-right-stage-2').length > 0) {
        $('.pxp-props-carousel-right-stage-2').owlCarousel({
            'nav': false,
            'dots': false,
            'margin': 30,
            'responsive': {
    ...
    if ($('.pxp-props-carousel-right-stage-3').length > 0) {
        $('.pxp-props-carousel-right-stage-3').owlCarousel({
            'nav': false,
            'dots': false,
            'margin': 30,
            'responsive': {
