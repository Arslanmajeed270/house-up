...
if(indexPageData && indexPageData.userStories && indexPageData.userStories.length){
  for(let i=0; i<indexPageData.userStories.length; i++){
    let item = (<div>
      <Link to="" /><div className="pxp-prop-card-explore" style={{backgroundImage: 'url(assets/images/dashboard/ottawa.png)'}}><Link to="">
                      ...
                      <div className="newsfeed">
                        <div className="container">
                          <div className="row">
                            ...
                            {
                            indexPageData && indexPageData.posts &&
                            indexPageData.posts.map((data, index) =>
                            <div className="dashboard-newsfeed">
                              <div className="dashboard-newsfeed-content">
                                <ul className="news-feed-user-ul">
                                  <Link to="/"><li>
                                      <span className="news-feed-user-img" style={{backgroundImage: `url(${data.profilePictureUrl ? data.profilePictureUrl : "assets/images/dashboard/sherlin.png"})`}} />
                                      <span className="news-feed-user-name">{data.user.firstName} {data.user.lastName}</span>
                                    </li></Link>
                                </ul>
                          ...
                          {indexPageData && indexPageData.postNdPropertiesList && 
                            indexPageData.postNdPropertiesList.map((index , data )=>(
                            ...
                            <div className="dashboard-newsfeed">
                              <div className="dashboard-newsfeed-content">
                                <ul className="news-feed-user-ul">
                                  <li>
                                    <span className="news-feed-user-img" style={{backgroundImage: `url(${data.user.profilePictureUrl ? data.user.profilePictureUrl : "assets/images/dashboard/sherlin.png"} )`}} />
                                    <span className="news-feed-user-name">{data.user.firstName} {data.user.lastName}</span>
                                  </li>
                                </ul>
                                <Link to=""><div className="dashboard-newsfeed-img" style={{backgroundImage: `url(${data.postImages.imageURL ? data.postImages.imageURL : "assets/images/dashboard/neraby-3.png"})`}}>
                                  </div></Link>
                                <Link to="" className="dashboard-newsfeed-contact nodecor" data-toggle="modal" data-target=""> Contact us</Link>
                                <div className="dashboard-newsfeed-header">{data.postText}</div>
                                <div className="dashboard-newsfeed-details"></div>
                                <div className="row">
                                  <div className="col-lg-4 col-md-4 col-sm-3 col-4">
                                    <div className="news-feed-icon-user">
                                      <p className="heart-p"><i className="far fa-heart" /> Like</p>
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-5 col-4">
                                    <div className="news-feed-icon-user">
                                      <Link to={data.postComments}><p className="comment-p"><i className="far fa-comment-alt" /> Comments</p></Link>
                                    </div>
                                  </div>
                                  <div className="col-lg-4 col-md-4 col-sm-4 col-4">
                                    <div className="news-feed-icon-user">
                            ...
                            :
                          <div key={index} className="dashboard-newsfeed">
                          <div className="dashboard-newsfeed-content">
                            <ul className="news-feed-user-ul">
                              <li>
                                <span className="news-feed-user-imgs" style={{backgroundImage: `url(${data.user.profilePictureUrl ? data.user.profilePictureUrl : "assets/images/dashboard/sherlin.png"} )`}} />
                                <span className="news-feed-user-name">{data.user.firstName} {data.user.lastName}</span>
                              </li>
                            </ul>
                            <Link to=""><div className="pxp-prop-card-featured" style={{backgroundImage: `url(${data.imageList[0].imageURL ? data.postImages[0].imageURL : "assets/images/dashboard/neraby-3.png"})`}}>
                                    ...
                                    <div className="row">
                                      <div className="col-md-6 col-sm-6 col-6">
                                        <div className="feature-head">
                                          <span><b>{data.currency.symbol} {data.price}</b>/per night</span>
                                        </div>
                                      </div>
                                      <div className="col-md-6 col-sm-6 col-6">
                                      </div>
                            ...
                            <Link to="" className="dashboard-newsfeed-contact nodecor" data-toggle="modal" data-target=""> Contact us</Link>
                            <dir />
                            <div className="dashboard-newsfeed-header">{data.adTitle}</div>
                            <div className="dashboard-newsfeed-details">{data.description}</div>
                            <div className="row">
                              <div className="col-lg-4 col-md-4 col-sm-3 col-4">
                                <div className="news-feed-icon-user">
                                  <p className="heart-p"><i className="far fa-heart" /> Like</p>
