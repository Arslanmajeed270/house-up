						...
						<Link>
							...
							>
								<div
									...
									onClick={() =>
										this.props.cardSelectionHandler('cardSelection')
									}
								>
									<Link to='#'>
										<div className='row'>
											<div className='col-md-3 logo-modal'>
												<img
													src={require('../../assets/images/icons/ic_monthly.svg')}
													alt=''
													style={{ height: '60px' }}
												/>
											</div>
											<div className='col-md-9'>
												...
												<div class='user-description'>
													$19.99 fist month & $29.99 per month
												</div>
											</div>
										</div>
									</Link>
								...
								>
									<Link to='#'>
										<div className='row'>
											<div className='col-md-3 logo-modal'>
												<img
													src={require('../../assets/images/icons/ic_annul.svg')}
													alt=''
													style={{ height: '60px' }}
												/>
											</div>
