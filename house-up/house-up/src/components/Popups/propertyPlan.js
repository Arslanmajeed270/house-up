        ...
        return ( 
            ...
            <Modal.Body>
                ...
                <Link >
                            ...
                            <Link to="#">
                                <div className="row">
                                    <div className="col-md-9">
                                        ...
                                        <div class="user-description">Lisiting property free...</div>
                                    </div>
                                </div>
                            </Link>
                        </div>
                            ...
                            <Link to="#">
                                <div className="row">
                                    <div className="col-md-9">
                                        ...
                                        <div class="user-description">Pay $10 for 20 days Reach1000 user</div>
                                    </div>
                                </div>
                            </Link>
                        </div>
                            ...
                            <Link to="#">
                                <div className="row" onClick={this.clickHandler}>
                                    <div className="col-md-9" >
                                        ...
                                        <div class="user-description">Pay $25 for 50 days Reach 5000 user</div>
                                        
                                    </div>
                                    <div className="col-md-2">
                                    <img src={this.state.clicked ? require('../../assets/images/ic_check_sel.svg') : require('../../assets/images/ic_check.svg')  } />
                                        </div>
                                </div>
                            </Link>
                        </div>
                    ...
                    {
                        this.state.propertyPlanState ? <CardSelection show={this.state.propertyPlanState} closeCodelHanlder={this.propertyPlanStateHandler} /> : ""
                    }
