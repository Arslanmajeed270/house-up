                ...
                <div className="pxp-hero vh-100">
                    ...
                    <div className="pxp-hero-caption">
                      <div className="container">
                        ...
                        <form className="pxp-hero-search mt-4" action="/properties">
                          <div className="row">
                  ...
                  <div className="container mt-100">
                    ...
                    <div className="row mt-4 mt-md-5">
                      <div className="col-sm-12 col-md-6 col-lg-3">
                        <Link to='/single-vendor' className="pxp-Vendors-1-item">
                          <div className="pxp-Vendors-1-item-fig-container rounded-lg">
                            <div className="pxp-Vendors-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/SingleVendor-1.jpg)', backgroundPosition: 'top center'}} />
                          </div>
                          <div className="pxp-Vendors-1-item-details rounded-lg">
                            <div className="pxp-Vendors-1-item-details-name">Scott Goodwin</div>
                            <div className="pxp-Vendors-1-item-details-email"><span className="fa fa-phone" /> (123) 456-7890</div>
                            <div className="pxp-Vendors-1-item-details-spacer" />
                            <div className="pxp-Vendors-1-item-cta text-uppercase">More Details</div>
                          </div>
                          <div className="pxp-Vendors-1-item-rating"><span><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /></span></div>
                        </Link>
                      </div>
                      <div className="col-sm-12 col-md-6 col-lg-3">
                        <Link to='/single-vendor' className="pxp-Vendors-1-item">
                          <div className="pxp-Vendors-1-item-fig-container rounded-lg">
                            <div className="pxp-Vendors-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/SingleVendor-2.jpg)', backgroundPosition: 'top center'}} />
                          </div>
                          <div className="pxp-Vendors-1-item-details rounded-lg">
                            <div className="pxp-Vendors-1-item-details-name">Alayna Becker</div>
                            <div className="pxp-Vendors-1-item-details-email"><span className="fa fa-phone" /> (456) 123-7890</div>
                            <div className="pxp-Vendors-1-item-details-spacer" />
                            <div className="pxp-Vendors-1-item-cta text-uppercase">More Details</div>
                          </div>
                          <div className="pxp-Vendors-1-item-rating"><span><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star-o" /></span></div>
                        </Link>
                      </div>
                      <div className="col-sm-12 col-md-6 col-lg-3">
                        <Link to='/single-vendor' className="pxp-Vendors-1-item">
                          <div className="pxp-Vendors-1-item-fig-container rounded-lg">
                            <div className="pxp-Vendors-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/SingleVendor-3.jpg)', backgroundPosition: 'top center'}} />
                          </div>
                          <div className="pxp-Vendors-1-item-details rounded-lg">
                            <div className="pxp-Vendors-1-item-details-name">Melvin Blackwell</div>
                            <div className="pxp-Vendors-1-item-details-email"><span className="fa fa-phone" /> (789) 123-4560</div>
                            <div className="pxp-Vendors-1-item-details-spacer" />
                            <div className="pxp-Vendors-1-item-cta text-uppercase">More Details</div>
                          </div>
                          <div className="pxp-Vendors-1-item-rating"><span><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /></span></div>
                      ...
                      <div className="col-sm-12 col-md-6 col-lg-3">
                        <Link to='/single-vendor' className="pxp-Vendors-1-item">
                          <div className="pxp-Vendors-1-item-fig-container rounded-lg">
                            <div className="pxp-Vendors-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/SingleVendor-4.jpg)', backgroundPosition: 'top center'}} />
                          </div>
                          <div className="pxp-Vendors-1-item-details rounded-lg">
                            <div className="pxp-Vendors-1-item-details-name">Erika Tillman</div>
                            <div className="pxp-Vendors-1-item-details-email"><span className="fa fa-phone" /> (890) 456-1237</div>
                            <div className="pxp-Vendors-1-item-details-spacer" />
                            <div className="pxp-Vendors-1-item-cta text-uppercase">More Details</div>
                          </div>
                          <div className="pxp-Vendors-1-item-rating"><span><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star" /><span className="fa fa-star-o" /></span></div>
                    ...
                    <div className="row mt-5">
                      <div className="col-sm-12 col-md-6 col-lg-4">
                        <Link to="" className="pxp-plans-1-item">
                          <div className="pxp-plans-1-item-fig">
                            <img src="assets/images/plan-personal.svg" alt="..." />
                          </div>
                          <div className="pxp-plans-1-item-title">Personal</div>
                          <ul className="pxp-plans-1-item-features list-unstyled">
                            <li>10 Listings</li>
                            <li>2 Featured Listings</li>
                          </ul>
                          <div className="pxp-plans-1-item-price">
                            <span className="pxp-plans-1-item-price-sum">Free</span>
                            <span className="pxp-plans-1-item-price-period"> / 1 month</span>
                          </div>
                      ...
                      <div className="col-sm-12 col-md-6 col-lg-4">
                        <Link to="" className="pxp-plans-1-item pxp-is-popular">
                          ...
                          <div className="pxp-plans-1-item-title">Professional</div>
                          <ul className="pxp-plans-1-item-features list-unstyled">
                            <li>10 Listings</li>
                            <li>2 Featured Listings</li>
                          </ul>
                          <div className="pxp-plans-1-item-price">
                            ...
                            <span className="pxp-plans-1-item-price-sum">49.99</span>
                            <span className="pxp-plans-1-item-price-period"> / 6 months</span>
                          </div>
                          <div className="pxp-plans-1-item-cta text-uppercase">Choose Plan</div>
                        </Link>
                      </div>
                      <div className="col-sm-12 col-md-6 col-lg-4">
                        <Link to="" className="pxp-plans-1-item">
                          <div className="pxp-plans-1-item-fig">
                            <img src="assets/assets/images/plan-business.svg" alt="..." />
                          </div>
                          <div className="pxp-plans-1-item-title">Business</div>
                          <ul className="pxp-plans-1-item-features list-unstyled">
                            <li>10 Listings</li>
                            <li>2 Featured Listings</li>
                          </ul>
                          <div className="pxp-plans-1-item-price">
                            <span className="pxp-plans-1-item-price-currency">$</span>
                            <span className="pxp-plans-1-item-price-sum">99.99</span>
                            <span className="pxp-plans-1-item-price-period"> / 1 year</span>
                          </div>
                          <div className="pxp-plans-1-item-cta text-uppercase">Choose Plan</div>
                        </Link>
                      </div>
