            ...
            <React.Fragment>
                ...
                <div className="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
                  ...
                  <div className="w-full p-t-100 p-b-90 p-l-48 p-l-0-md">
                    <h3 className="l1-txt1 p-b-34 respon3">
                      Coming Soon
                    </h3>
                  ...
                  <div className="flex-w flex-m">
                    <span className="m2-txt2 p-r-40">
                      Follow us
                    </span>
                    <Link to="https://www.facebook.com/Houseup.ca" target="_blank" className="size3 flex-c-m how-social trans-04 m-r-15 m-b-5 m-t-5">
                      <i className="fa fa-facebook" />
                    </Link>
                    <Link to="https://www.instagram.com/houseup.ca/" target="_blank" className="size3 flex-c-m how-social trans-04 m-r-15 m-b-5 m-t-5">
                      <i className="fa fa-instagram" />
                    </Link>
                    <Link to="http://myxpapp.com/houseup.ca" target="_blank" className="size3 flex-c-m how-social trans-04 m-r-15 m-b-5 m-t-5">
                      <i className="fa fa-github" />
                    </Link>
                  </div>
                </div>
                <div className="wsize2 bg-img1 respon2" style={{backgroundImage: 'url("assets/images/bg01.jpg")'}}>
                </div>
              </div>
            </React.Fragment>
         );
