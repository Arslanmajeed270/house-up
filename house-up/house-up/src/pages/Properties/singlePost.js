            ...
            <React.Fragment>
                ...
                <div className="pxp-blog-posts pxp-content-wrapper mt-100">
                  <div className="container">
                    <div className="row">
                      <div className="col-sm-12 col-md-7">
                        <div className="pxp-blog-post-category"><span>April 9, 2019</span><span>Interior Design</span></div>
                  ...
                  <div className="pxp-blog-post-hero mt-4 mt-md-5">
                    <div className="pxp-blog-post-hero-fig pxp-cover" style={{backgroundImage: 'url(assets/images/single-post-fig.jpg)', backgroundPosition: '50% 50%'}} />
                  </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-12 col-lg-10">
                        ...
                        <div className="pxp-blog-post-block pxp-full mt-4 mt-md-5">
                          <Link to="" className="pxp-blog-post-video pxp-cover" style={{backgroundImage: 'url(assets/images/hero-prop-12.jpg)', backgroundPosition: '50% 50%'}} />
                          <iframe title="Video" width={889} height={500} src="https://www.youtube.com/embed/4Wee4LASqvE?start=23" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen style={{width: '100%', border: '0 none'}} />
                        </div>
                        ...
                        <div className="pxp-blog-post-block pxp-full mt-4 mt-md-5">
                          <div className="row">
                            <div className="col-sm-12 col-md-6">
                              <img src="assets/images/hero-prop-3.jpg" alt="" className="pxp-image-full mb-3" />
                            </div>
                            <div className="col-sm-12 col-md-6">
                              <img src="assets/images/hero-prop-10.jpg" alt="" className="pxp-image-full mb-3" />
                            </div>
                          </div>
                        </div>
                        <div className="pxp-blog-post-block mt-4 mt-md-5">
                  ...
                  <div className="container mt-100">
                    ...
                    <div className="row mt-4 mt-md-5">
                      <div className="col-sm-12 col-md-6 col-lg-4">
                        <Link to="" className="pxp-posts-1-item">
                          <div className="pxp-posts-1-item-fig-container">
                            <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/posts-1.jpg)'}} />
                          </div>
                      ...
                      <div className="col-sm-12 col-md-6 col-lg-4">
                        <Link to="" className="pxp-posts-1-item">
                          <div className="pxp-posts-1-item-fig-container">
                            <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/posts-2.jpg)'}} />
                          </div>
                          <div className="pxp-posts-1-item-details">
                      ...
                      <div className="col-sm-12 col-md-6 col-lg-4">
                        <Link to="" className="pxp-posts-1-item">
                          <div className="pxp-posts-1-item-fig-container">
                            <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/posts-3.jpg)'}} />
                          </div>
                          <div className="pxp-posts-1-item-details">
                            <div className="pxp-posts-1-item-details-category">Interior Design</div>
                      ...
                      <div className="col-sm-12 col-lg-10">
                        <div className="pxp-blog-post-block">
                          <div className="pxp-blog-post-comments">
                            ...
                            <div className="mt-3 mt-md-4">
                              <div className="media">
                                ...
                                <div className="media-body">
                                  <h5>Scott Goodwin</h5>
                                  <div className="pxp-blog-post-comments-date">April 9, 2019 at 2:33 pm</div>
                            ...
                            <form action="/single-post" className="pxp-blog-post-comments-form mt-3 mt-md-4">
                              <div className="row">
                                <div className="col-sm-12 col-md-6">
                                  <div className="form-group">
                                    <label htmlFor="pxp-blog-post-comments-name">You Name</label>
                                    <input type="text" className="form-control" id="pxp-blog-post-comments-name" placeholder="Enter your full name" />
                                  </div>
                                </div>
                                <div className="col-sm-12 col-md-6">
                                  <div className="form-group">
                                    <label htmlFor="pxp-blog-post-comments-email">You Email</label>
                                    <input type="text" className="form-control" id="pxp-blog-post-comments-email" placeholder="Enter your email address" />
                                  </div>
                                </div>
                              </div>
                              <div className="form-group">
                                <label htmlFor="pxp-blog-post-comments-reply">Leave a Reply</label>
                                <textarea className="form-control" id="pxp-blog-post-comments-reply" rows={6} placeholder="Write your comment here..." defaultValue={""} />
                              </div>
                              <Link to="" className="pxp-blog-post-comments-form-btn">Post Comment</Link>
                            </form>
                          </div>
                        </div>
                      </div>
