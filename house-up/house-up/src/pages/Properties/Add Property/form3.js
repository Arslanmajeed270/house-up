...
class form3 extends Component {
	...
	render() {
		const {
			yearBuilt, disposal, finishedSqftArea, lotDimensionLength,
			noOfBathrooms, basementId, waterSourceID, propertyTypeId,
			lotDimensionWidth, storeys, rentalListingYN, yearRoofInstalled,
			parkingSpaces, ac, garageId, dishWasher, garage,
			noOfBedrooms, playroom, primaryHeatingFuelId, internet,
			buildingTypeId, gym, yearFurnaceBuilt,
			areaTypeId, lotTotalArea, propertyType, parkingSpace,
			bedroomCount, bathroomCount, basementType, garageType,
			primaryHeatingFuel, waterSource, storeysCount, areaType,
			buildingType, condoFee,
		} = this.state;
