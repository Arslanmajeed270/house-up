...
class form4 extends Component {
	...
	componentDidMount() {
		this.setState({
			...
			autoRenew: this.props.form4Data
				? this.props.form4Data.packageRenewal
				: '',
			...
			>
				...
				<div className='row'>
							...
							? feeTypes.map((data, index) => (
									...
									>
										...
										<div className='col-md-1'>
											<img
												src={require(this.state.feeId ===
													data.propertyPostingFeeId
					...
					<div className='col-md-6'>
						...
						<div>
							<div>
								<button className='more-options' onClick={this.addCardToggle}>
									Add New Card
								</button>
