				...
				>
					...
					<div className='row' style={{ marginTop: '20px' }}>
						...
						<div className='col-md-6'>
							...
							<span
								className='text-danger titles-property'
								style={{ fontWeight: 'bold' }}
							>
								Inlcude your local tax in price.
							</span>
							<br />
							<span className='text-danger titles-property'>
								( i.e. $1.00 + tax 13% = $1.13 )
							</span>
						</div>
						<div className='col-md-6'>
												...
												<tr key={idx}>
													<td>
														<input
															...
															name='varient'
															value={data.varient}
															onChange={this.onChangeTableContent(idx)}
														/>
													</td>
													<td>
														<input
													...
													<td className='table-remove'>
														<span onClick={() => this.removeTableContent(idx)}>
															x
														</span>
													</td>
												</tr>
