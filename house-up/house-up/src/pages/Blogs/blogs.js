                      ...
                      <div id="pxp-blog-posts-carousel-1-img" className="carousel slide pxp-blog-posts-carousel-1-img" data-ride="carousel" data-pause="false" data-interval="false">
                        <div className="carousel-inner">
                          <div className="carousel-item active" data-slide={0}>
                            <div className="pxp-hero-bg pxp-cover" style={{backgroundImage: 'url(assets/images/prop-7-2-big.jpg)', backgroundPosition: '50% 50%'}} />
                          </div>
                          <div className="carousel-item" data-slide={1}>
                            <div className="pxp-hero-bg pxp-cover" style={{backgroundImage: 'url(assets/images/prop-3-1-big.jpg)', backgroundPosition: '50% 50%'}} />
                          </div>
                          <div className="carousel-item" data-slide={2}>
                            <div className="pxp-hero-bg pxp-cover" style={{backgroundImage: 'url(assets/images/prop-3-3-big.jpg)', backgroundPosition: '50% 50%'}} />
                          </div>
                          <div className="carousel-item" data-slide={3}>
                            <div className="pxp-hero-bg pxp-cover" style={{backgroundImage: 'url(assets/images/prop-1-1-big.jpg)', backgroundPosition: '50% 50%'}} />
                          </div>
                        </div>
                      </div>
                      <div className="pxp-carousel-controls">
                        <Link to="" className="pxp-carousel-control-prev" role="button" data-slide="prev">
                        ...
                        <Link to="" className="pxp-carousel-control-next" role="button" data-slide="next">
                          <svg xmlns="http://www.w3.org/2000/svg" width="32.414" height="20.828" viewBox="0 0 32.414 20.828">
                        ...
                        <div id="pxp-blog-posts-carousel-1-caption" className="carousel slide pxp-blog-posts-carousel-1-caption" data-ride="carousel" data-pause="false" data-interval="false">
                          <div className="carousel-inner">
                            <div className="carousel-item active" data-slide={0}>
                              ...
                              <Link to='/single-post'  className="pxp-primary-cta text-uppercase mt-3 mt-md-4 pxp-animate">Read Article</Link>
                            </div>
                            <div className="carousel-item" data-slide={1}>
                      ...
                      <div className="col-sm-12 col-lg-9">
                        <div className="row">
                          <div className="col-sm-12 col-md-6">
                            <Link to='/single-post'  className="pxp-posts-1-item">
                              <div className="pxp-posts-1-item-fig-container">
                                <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/post-1.jpg)'}} />
                              </div>
                          ...
                          <div className="col-sm-12 col-md-6">
                            <Link to='/single-post'  className="pxp-posts-1-item">
                              <div className="pxp-posts-1-item-fig-container">
                                <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/post-2.jpg)'}} />
                              </div>
                              <div className="pxp-posts-1-item-details">
                          ...
                          <div className="col-sm-12 col-md-6">
                            <Link to='/single-post'  className="pxp-posts-1-item">
                              <div className="pxp-posts-1-item-fig-container">
                                <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/post-3.jpg)'}} />
                              </div>
                              <div className="pxp-posts-1-item-details">
                                <div className="pxp-posts-1-item-details-category">Interior Design</div>
                          ...
                          <div className="col-sm-12 col-md-6">
                            <Link to='/single-post'  className="pxp-posts-1-item">
                              <div className="pxp-posts-1-item-fig-container">
                                <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/post-4.jpg)'}} />
                              </div>
                              <div className="pxp-posts-1-item-details">
                                <div className="pxp-posts-1-item-details-category">Interior Design</div>
                                <div className="pxp-posts-1-item-details-title">What to Expect When Working with an Interior Designer</div>
                          ...
                          <div className="col-sm-12 col-md-6">
                            <Link to='/single-post'  className="pxp-posts-1-item">
                              <div className="pxp-posts-1-item-fig-container">
                                <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/post-5.jpg)'}} />
                              </div>
                              <div className="pxp-posts-1-item-details">
                                <div className="pxp-posts-1-item-details-category">Architecture</div>
                                <div className="pxp-posts-1-item-details-title">Private Contemporary Home Balancing Openness</div>
                          ...
                          <div className="col-sm-12 col-md-6">
                            <Link to='/single-post'  className="pxp-posts-1-item">
                              <div className="pxp-posts-1-item-fig-container">
                                <div className="pxp-posts-1-item-fig pxp-cover" style={{backgroundImage: 'url(assets/images/post-6.jpg)'}} />
                              </div>
                              <div className="pxp-posts-1-item-details">
                                <div className="pxp-posts-1-item-details-category">Interior Design</div>
                                <div className="pxp-posts-1-item-details-title">Stylish Modern Ranch Exuding a Welcoming Feel</div>
                      ...
                      <div className="col-sm-12 col-lg-3 mt-4 mt-md-5 mt-lg-0">
                        <div className="pxp-blog-posts-side-section">
                          ...
                          <div className="mt-3 mt-md-4">
                            <div className="form-group">
                              <input type="text" className="form-control pxp-is-address" placeholder="Search" />
                        ...
                        <div className="pxp-blog-posts-side-section mt-4 mt-md-5">
                          ...
                          <ul className="pxp-blog-posts-side-v-list list-unstyled mt-3 mt-md-4">
                            <li><Link to="">Fashion (3)</Link></li>
                            <li><Link to="">Lifestyle (2)</Link></li>
                            <li><Link to="">Personal (2)</Link></li>
                            <li><Link to="">Stories (2)</Link></li>
                            <li><Link to="">Travel (4)</Link></li>
                          </ul>
                        </div>
                        <div className="pxp-blog-posts-side-section mt-4 mt-md-5">
                          <h3>Tags</h3>
