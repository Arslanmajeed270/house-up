				...
				<div className='pxp-content'>
					<div className='pxp-contact pxp-content-wrapper mt-100'>
						...
						<div className='pxp-contact-hero mt-4 mt-md-5'>
							<div
								className='pxp-contact-hero-fig pxp-cover'
								style={{
									...
									<div className='pxp-contact-hero-offices'>
										...
										<div className='row'>
											<div className='col-sm-12 col-md-4'>
												<div className='pxp-contact-hero-offices-title mt-3 mt-md-4'>
													Bancroft
												</div>
												<div className='pxp-contact-hero-offices-info mt-2 mt-md-3'>
													<p className='pxp-is-address'>
														90 Fifth Avenue, 3rd Floor
														<br />
														Bancroft, CA 1980
													</p>
													<p>
														<Link to=''>(123) 789-7390</Link>
														<br />
								...
								<div className='col-sm-12 col-lg-6'>
									...
									<div className='pxp-contact-form mt-3 mt-md-4'>
										...
										<div className='form-group'>
											<textarea
												className='form-control'
												id='pxp-contact-form-message'
												rows={6}
												placeholder='Message'
												defaultValue={''}
											/>
										</div>
										<Link to='' className='pxp-contact-form-btn'>
											Send Message
										</Link>
									</div>
								</div>
