...
class index extends Component {
  ...
  socialShareHanlder = (platform , id) => {
    if(platform === 'facebook'){
      window.open(`https://www.facebook.com/sharer/sharer.php?u=${window.location.hostname}/${id}`)
      ...
      window.open(`https://telegram.me/share/url?url=${window.location.hostname}/${id}`)
    }else if(platform === 'mail'){
      window.open(`https://mail.google.com/mail/u/0/?ui=2&view=cm&fs=1&tf=1&su=HouseUp&body=${window.location.hostname}/${id}`)
    }
