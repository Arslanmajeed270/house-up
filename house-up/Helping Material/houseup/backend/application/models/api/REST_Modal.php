...
class REST_Modal extends CI_Model {
...

    {
		...
		public function login($data){
			...
			//echo "SELECT * FROM `hu_users` WHERE user_name='".$data['user_name']."'  AND password='".$data['password']."'";exit;

			$query = $this->db->query("SELECT first_name,last_name FROM `hu_users` WHERE user_name='".$data['user_name']."'  AND password='".$data['password']."'");
